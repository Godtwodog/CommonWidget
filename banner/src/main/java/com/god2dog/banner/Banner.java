...
import com.god2dog.banner.indicator.Indicator;
import com.god2dog.banner.itemdecoration.MarginDecoration;
import com.god2dog.banner.listener.OnBannerListener;
import com.god2dog.banner.listener.OnPageChangeListener;
import com.god2dog.banner.transformer.MultipleScaleTransformer;
import com.god2dog.banner.util.BannerUtils;
import com.god2dog.banner.util.ScrollSpeedManger;
...
public class Banner<T, BA extends BannerAdapter> extends FrameLayout {
    ...
    public Banner setBannerRound2(final float radius) {
