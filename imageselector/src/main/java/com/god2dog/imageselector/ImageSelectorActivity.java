...
import com.god2dog.imageselector.adapter.FolderAdapter;
import com.god2dog.imageselector.adapter.ImageAdapter;
import com.god2dog.imageselector.entry.Folder;
import com.god2dog.imageselector.entry.Image;
import com.god2dog.imageselector.entry.RequestConfig;
import com.god2dog.imageselector.model.ImageModel;
import com.god2dog.imageselector.utils.DateUtils;
import com.god2dog.imageselector.utils.ImageSelector;
import com.god2dog.imageselector.utils.UriUtils;
import com.god2dog.imageselector.utils.VersionUtils;
...
public class ImageSelectorActivity extends AppCompatActivity {
    ...
    private void setSelectImageCount(int count) {
        if (count == 0) {
            ...
            tvPreview.setTextColor(Color.parseColor("#FF999999"));
            tvConfirm.setTextColor(Color.parseColor("#804490f6"));
            tvImageNum.setVisibility(View.GONE);
        } else {
            btnConfirm.setEnabled(true);
            btnPreview.setEnabled(true);
            tvImageNum.setVisibility(View.VISIBLE);
            tvPreview.setTextColor(Color.parseColor("#FF333333"));
            tvConfirm.setTextColor(Color.parseColor("#FF4490f6"));
...
//                tvConfirm.setText(getString(R.string.selector_send) + "(" + count + ")");
    ...
    private void openFolder() {
        Log.i("dengxs","startMeasuredHeight:"+rlTopBar.getMeasuredHeight());
        Log.i("dengxs","startHeight:"+rlTopBar.getHeight());
        if (!isOpenFolder) {
