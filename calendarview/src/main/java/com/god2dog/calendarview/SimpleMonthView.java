...
class SimpleMonthView extends View {
    ...
    protected static int ROW_SEPARATOR = 0;                            // 每行中间的间距
    ...
    protected void drawMonthCell(Canvas canvas) {
        ...
        while (day <= mNumCells) {
            ...
            if (mHasToday && (mToday == day)) {
                isToady = true;
                canvas.drawText("今天", x, getTextYCenter(mDayTextPaint,y) , mDayTextPaint);
            }
...
//        drawMonthDayLabels(canvas);
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        mRowHeight = (width - mPadding * 2) / mNumDays  ;
...
//        }
        ...
        mMonth = (int) params.get(VIEW_PARAMS_MONTH) - 1;
    ...
    private void drawDayBg(Canvas canvas, int x, int y, Paint paint) {
        RectF rectF = new RectF(x  - mRowHeight / 2, y - mRowHeight / 2,
                x + mRowHeight / 2 , y + mRowHeight / 2);
